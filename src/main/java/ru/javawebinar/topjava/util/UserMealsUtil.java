...
//        .toLocalTime();
    ...
    public static List<UserMealWithExceed>  getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        //Map <Date, Calories>
        Map<LocalDate, Integer> totalByDate = mealList.stream()
        ...
        return mealList.stream()
                ...
                .map(userMeal -> new UserMealWithExceed(userMeal, totalByDate.get(userMeal.getDateTime().toLocalDate()) > caloriesPerDay))
